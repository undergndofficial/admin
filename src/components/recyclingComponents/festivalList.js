...
function FestivalList(props) {
  ...
  const changeCheckbox = (e) => {
    if (e.target.checked) {
      setCheckedData(props.data.mov_seq);
    }
    else setCheckedData();
  }
  ...
  return(
    ...
    <table className="list">
      ...
      <Page showEl={showEl} listData={props.datas} elements={props.elements} checkedData={checkedData} setCheckedData={setCheckedData} setManageModal={props.setManageModal} />
  ...
  return(
      <tbody>
      {
        ...
        props.listData.map((data) => {
          return(
            <ListElement key={data.mov_seq} data={data} showEl={props.showEl} elements={props.elements} checkedData={props.checkedData} setCheckedData={props.setCheckedData} setManageModal={props.setManageModal} />
          )
        })
        :
...
function ListElement(props) {
  ...
  const checkBoxChagne = (e) => {
    if (e.target.checked) props.setCheckedData(props.data.mov_seq);
    else props.setCheckedData('');    
  }
  ...
  return(
    <tr>
    <td>
      <input className="listCheckbox" type={"checkbox"} checked={props.data.mov_seq === props.checkedData} onChange={(e) => checkBoxChagne(e)} />
    </td>
      {
        props.showEl.map((elKeyName) => {
        return(
          <td key={elKeyName} className="el" onClick={() => {navigate('/festival/detail/'+props.data.mov_seq)}} >
            {
